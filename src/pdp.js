...
<nav>
  ...
  <div class="nav-actions">
    <!-- The cart, which this page had no way to reach.
    
         Adding something here said "Added ✓" on the button and then offered no
         route to the cart at all — you had to navigate to the homepage to see
         what was in it. On a phone that is the whole nav, so there was nothing
         else to fall back on.
    
         A LINK to /#cart rather than a drawer of its own: the drawer, the
         pricing and the Razorpay flow all live in main.js, and "Buy now" on this
         page already hands off to the homepage for exactly that reason. Two
         implementations of the cart is the last thing this needs.
    
         The badge is filled in by product.js from localStorage; it starts hidden
         so it never flashes "0" before the script runs. -->
    <a href="/#cart" class="nav-cart pdp-cart" id="pdpCartLink" aria-label="Open cart">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
      <span class="cart-badge" id="pdpCartBadge" hidden>0</span>
    </a>
